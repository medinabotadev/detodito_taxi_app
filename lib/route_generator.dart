...
import 'src/pages/chat_shipping.dart';
import 'src/pages/forget_password.dart';
import 'src/pages/help.dart';
import 'src/pages/image_detail.dart';
...
import 'src/pages/shipping_detail.dart';
import 'src/pages/shipping_edit.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/ShippingDetail':
        return MaterialPageRoute(builder: (_) => ShippingDetailWidget(shipping: args,));
      case '/ShippingEdit':
        return MaterialPageRoute(builder: (_) => ShippingEditWidget(shipping: args,));
      case '/ShippingChat':
        return MaterialPageRoute(
            builder: (_) => ChatShippingWidget(routeArgument: args as RouteArgument));
      case '/DetailImage':
        return MaterialPageRoute(builder: (_) => ImageDetailWidget(imageUrl: args));
      default:
